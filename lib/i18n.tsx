...
const translations: Record<string, { en: string; nl: string }> = {
  ...
  "filter.daysOldest": { en: "Days in stock (oldest)", nl: "Dagen in voorraad (oudste)" },
  "filter.priceLowHigh": { en: "Price (low to high)", nl: "Prijs (laag naar hoog)" },
  "filter.priceHighLow": { en: "Price (high to low)", nl: "Prijs (hoog naar laag)" },
  "filter.mileageLowHigh": { en: "Mileage (low to high)", nl: "Kilometerstand (laag naar hoog)" },
  "filter.mileageHighLow": { en: "Mileage (high to low)", nl: "Kilometerstand (hoog naar laag)" },
  "filter.nameAZ": { en: "Name (A-Z)", nl: "Naam (A-Z)" },
  "filter.nameZA": { en: "Name (Z-A)", nl: "Naam (Z-A)" },
